...
namespace ResourceRun.World
{
    ...
    public class ObjectGroup : ScriptableObject
    {
        ...
        [Tooltip(
            "The shared positional offset of this ObjectGroup. This applies to world position, not grid position!")]
    ...
    {
        [Tooltip(
            "The relative weight of this variant being generated. A higher weight means a higher chance of being picked out")]
        public int weight;
        ...
        [Tooltip(
            "The size of the BoxCollider2D of this variant. If a BoxCollider2D is not present on the prefab, this will simply be ignored")]
